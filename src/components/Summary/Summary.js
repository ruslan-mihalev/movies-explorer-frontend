        ...
        <div className={className}>
            <div className="summary__info-container">
                <div className='summary__personal-info-container'>
                    ...
                    <SimpleText className='summary__detail-info'>Учился в Казани. Начинал карьеру там-же. После переехал в Москву. Начинал как мобильный разработчик, сейчас плавно перехожу в фулстек.
                       </SimpleText>
                </div>
