...
export const EMPTY_RESULT_ERROR = 'Ничего не найдено';
...
export  const GET_MOVIES_ERROR_MESSAGE = 'Во время запроса произошла ошибка. Возможно, проблема с соединением или сервер недоступен. Подождите немного и попробуйте ещё раз';
export  const GET_FAVORITE_MOVIES_ERROR_MESSAGE = 'Во время запроса произошла ошибка. Возможно, проблема с соединением или сервер недоступен. Подождите немного и попробуйте ещё раз';
export  const ADD_MOVIE_TO_FAVORITES_ERROR_MESSAGE = 'При добавлении фильма в избранное произошла ошибка.';
export  const REMOVE_MOVIE_FROM_FAVORITES_ERROR_MESSAGE = 'При удалении фильма из избранного произошла ошибка.';
